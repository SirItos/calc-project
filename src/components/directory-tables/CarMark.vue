...
<script>
    ...
    import c_modal from './CarMarkaInputs/modal'
    export default {
        name: "car_mark",
        components:{
            c_modal
        ...
        methods: {
            ...
            create_set(){
                return {
                    CarMarka_ID:null,
                    'Название':'',
                    ManufactoryLocalization_ID:null,
                    ManufactoryLocalization_Локализация:null,
                    ...
                    type:{
                        ...
                        ManufactoryLocalization_ID:"bigint identity",
                        ManufactoryLocalization_Локализация:"nvarchar",
